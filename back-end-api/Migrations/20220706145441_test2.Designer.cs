...
namespace back_end_api.Migrations
{
    ...
    [Migration("20220706145441_test2")]
    partial class test2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("back_end_api.Repository.Models.Flight", b =>
                {
                    b.HasOne("back_end_api.Repository.Models.Station", "InStation")
                        .WithMany()
                        .HasForeignKey("StationId");

                    b.Navigation("InStation");
                });

            modelBuilder.Entity("back_end_api.Repository.Models.Station", b =>
                {
                    b.HasOne("back_end_api.Repository.Models.Flight", "FlightInStation")
                        .WithOne()
                        .HasForeignKey("back_end_api.Repository.Models.Station", "FlightId");

                    b.Navigation("FlightInStation");
                });
